...
function _regexpExecIter() {
  _regexpExecIter = _wrapAsyncGenerator(
  /*#__PURE__*/
  _regeneratorRuntime.mark(function _callee(re, iterable) {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 16:
            ...
            matches = [];
            buffer += chunk;
            _iterator2 = regexExec(re, buffer), _isArray = Array.isArray(_iterator2), _i = 0, _iterator2 = _isArray ? _iterator2 : _getIterator(_iterator2);
          ...
          case 60:
            ...
            return _context.delegateYield(_asyncGeneratorDelegate(_asyncIterator(matches), _awaitAsyncGenerator), "t1", 62);
