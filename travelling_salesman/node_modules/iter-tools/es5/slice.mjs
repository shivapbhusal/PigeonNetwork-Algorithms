...
var _marked =
/*#__PURE__*/
_regeneratorRuntime.mark(slice);
...
function slice(opts, iterable) {
  ...
  return _regeneratorRuntime.wrap(function slice$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          currentPos = 0;
          nextValidPos = start;
          _iterator = iter(iterable), _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : _getIterator(_iterator);
