...
var _marked =
/*#__PURE__*/
_regeneratorRuntime.mark(regexpExecIter);
...
function regexpExecIter(re, iterable) {
  ...
  return _regeneratorRuntime.wrap(function regexpExecIter$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 15:
          ...
          matches = [];
          buffer += chunk;
          _iterator2 = regexExec(re, buffer), _isArray2 = Array.isArray(_iterator2), _i2 = 0, _iterator2 = _isArray2 ? _iterator2 : _getIterator(_iterator2);
