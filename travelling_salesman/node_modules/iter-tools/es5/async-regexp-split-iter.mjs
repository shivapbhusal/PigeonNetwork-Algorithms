...
function _regexpSplitIter() {
  _regexpSplitIter = _wrapAsyncGenerator(
  /*#__PURE__*/
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 17:
            queue = [];
            buffer += chunk;
            _iterator2 = regexSplit(re, buffer), _isArray = Array.isArray(_iterator2), _i = 0, _iterator2 = _isArray ? _iterator2 : _getIterator(_iterator2);
          ...
          case 62:
            ...
            return _context.delegateYield(_asyncGeneratorDelegate(_asyncIterator(queue), _awaitAsyncGenerator), "t1", 64);
