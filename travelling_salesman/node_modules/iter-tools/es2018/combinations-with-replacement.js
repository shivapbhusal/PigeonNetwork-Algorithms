...
function* combinationsWithReplacement(iterable, r) {
  const arr = Array.from((0, _iter.default)(iterable));
  const mapToIndex = (0, _map.default)(function (i) {
    return arr[i];
  });
  const n = arr.length;

  for (let indices of (0, _product.default)(...(0, _tee.default)((0, _range.default)(n), r))) {
    if (isSorted(indices)) {
